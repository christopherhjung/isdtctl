...
//! transport, and a client that ties them together. The command line tool
//! `isdtctl` is a separate crate built on this one, and has no privileged
//! access; anything it does, you can do.
//!
...
//! let client_id = isdt_charger::tokens::parse("9102782c5bfb5047a4533d071feb6eca")?;
//! let mut charger =
...
//!
//! ```
//! use isdt_charger::{frame, Request, Response};
//!
